...
-- ① categories_master への正常登録 (現時点の最新データ)
INSERT INTO categories_master (category_id, user_id, category_name, color_index, is_active) VALUES 
(1, 1, '食費',     0, true), 
(2, 1, '日用品',   1, true),
(3, 1, '趣味・娯楽', 2, true),
(4, 1, '交際費',   3, true),
...
(11, 1, '必要経費', 0, true, '2026-04-15 10:00:00'), 
(12, 1, 'ごほうび', 1, true, '2026-04-15 10:00:00'),
(13, 1, '推し活',   2, true, '2026-04-15 10:00:00'),
(14, 1, 'カフェ',   3, true, '2026-04-15 10:00:00'),
(15, 1, 'わからない', 4, true, '2026-04-15 10:00:00'),
(16, 1, '予備枠',   5, true, '2026-04-15 10:00:00'); -- 💡 空欄テスト用に文字を入れてあります
...
(1, 11, 1, '2026-04-15 10:00:00'),
(1, 12, 2, '2026-04-15 10:00:00'),
(1, 13, 3, '2026-04-15 10:00:00'),
(1, 14, 4, '2026-04-15 10:00:00'),
(1, 15, 5, '2026-04-15 10:00:00'),
(1, 16, 6, '2026-04-15 10:00:00');
